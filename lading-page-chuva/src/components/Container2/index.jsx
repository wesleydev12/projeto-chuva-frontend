    ...
    <div>
      ...
      <Box className='box-main-resumo'>
        ...
        <Box className='text-lorem'>
          ...
          <p className='text-center-hidden2'>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus vitae turpis auctor, mollis felis ut, commodo turpis. Phasellus felis mauris, egestas eget cursus et, iaculis quis lacus. <span className='text-center-hidden1'> Fusce auctor eros sed magna ultricies gravida. Etiam aliquam dictum nisl, vel aliquet enim accumsan sit amet. </span> <b>ver mais</b>
          </p>
